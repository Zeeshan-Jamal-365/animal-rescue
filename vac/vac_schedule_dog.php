...
$sql = "SELECT * FROM vac_schedule_dog";
...
<head>
    ...
    <title>dog Vaccine Schedule</title>
...
<body>
    ...
    <div class="container">
        <h2><b>Dog Vaccine Schedule</b></h2>
        <!-- Content here -->
        <table class="table table-light table-striped table-hover">
            <thead>
                <th>dog Vaccine</th>
                <th>Initial Kitten Vaccination (at or under 16 weeks) Initial Adult dog Vaccination (over 16 weeks) Booster Recommendation Comments</th>
                <th>Initial Adult dog Vaccination (over 16 weeks)</th>
            ...
            <tbody>
                ...
                if ($result->num_rows > 0) {
                    ...
                    while ($row = $result->fetch_assoc()) {
                        echo '<tr>';
                        echo '<td>' . $row['Dog_Vaccine'] . '</td>';
                        echo '<td>' . $row['Initial_Puppy_Vaccination'] . '</td>';
                        echo '<td>' . $row['Initial_Adult_Dog_Vaccination'] . '</td>';
