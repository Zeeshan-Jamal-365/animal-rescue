...
<head>
    ...
    $result = mysqli_query($conn, "SELECT id,fname,lname,email,w_area,city,date_created from users where email='$email'");
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav ml-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="../vac/vac_schedule_cat.php">Cat vaccine schedule</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="../vac/vac_schedule_dog.php">Dog vaccine schedule</a>
                    </li>
